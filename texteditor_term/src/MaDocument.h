...
public:
	...
	void Mac_Next(bool from_undo = false); //undoed
	void Mac_Prev(bool from_undo = false); //undoed
	void Mac_Insert(int n, string new_text, bool from_undo = false); //undoed
	void Mac_Delete(int n,bool from_undo = false); //undoed
	void Mac_Move(int n, int m, bool from_undo = false); //undoed
